...
export default function LoginPage() {
  ...
  const handleGoogleMock = async () => {
    const mockEmail = prompt("Since we are in local dev without OAuth, please enter the Gmail address you want to simulate login for:");
    if (!mockEmail) return;

    setLoading(true);
    setError("");
    try {
      // First try to register/login via mock
      ...
      if (res.ok) {
        ...
        setError(data.detail || "Google login simulation failed");
      }
    } catch (err) {
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 relative">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <p className="text-navy/60 font-light mb-6">Sign in to access your saved collections and orders.</p>
          </motion.div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <motion.div variants={itemVariants} className="relative">
              ...
              <div className="flex justify-end mt-2">
                <a href="#" className="text-xs text-navy/60 hover:text-gold transition-colors">Forgot password?</a>
              </div>
            </motion.div>
          ...
          <motion.div variants={itemVariants} className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-cream text-navy/40 uppercase tracking-widest text-xs">Or continue with</span>
              </div>
            </div>
