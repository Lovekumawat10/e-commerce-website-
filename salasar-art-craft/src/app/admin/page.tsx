  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 gap-4">
        {[
          { id: "#RTN-023", order: "#ORD-090", cust: "Priya Singh", issue: "Minor scratch on the base during transit. Requesting replacement or partial refund.", status: "Pending Review", type: "Return" },
          { id: "#CMP-104", order: "#ORD-085", cust: "Arjun Rao", issue: "Delayed delivery by 3 days. Seeking clarification from logistics.", status: "Investigating", type: "Complaint" },
        ].map((ticket, i) => (
            ...
            <div className="flex flex-col lg:flex-row justify-between lg:items-start gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
                  <span className="font-semibold text-navy text-sm bg-navy/5 px-3 py-1 rounded-md">{ticket.id}</span>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <p className="text-sm font-medium text-navy">{ticket.cust}</p>
                  </div>
                  <div>
                    <p className="text-xs text-navy/50 uppercase tracking-wider mb-1">Order Ref</p>
                    <p className="text-sm font-medium text-navy">{ticket.order}</p>
                  </div>
                </div>
                <div>
              ...
              <div className="flex flex-row lg:flex-col gap-3 min-w-[200px]">
                <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-green-50 text-green-700 border border-green-200 text-sm font-medium rounded-lg hover:bg-green-100 transition-colors">
                  <CheckCircle size={16} /> Approve
                </button>
                <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-red-50 text-red-700 border border-red-200 text-sm font-medium rounded-lg hover:bg-red-100 transition-colors">
                  <XCircle size={16} /> Reject
                </button>
                <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-navy text-white text-sm font-medium rounded-lg hover:bg-navy-dark transition-colors">
