    ...
    <div className="space-y-6 md:space-y-8 pb-8 md:pb-12">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 space-y-8">
          ...
          {/* Recent Orders Table */}
          <div className="bg-white p-4 md:p-6 rounded-xl border border-navy/5 shadow-sm">
        ...
        <div className="xl:col-span-1">
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl border border-navy/5 shadow-sm sticky top-0">
...
const MetricCard = ({ title, value, trend, alert = false }: { title: string, value: string, trend: string, alert?: boolean }) => {
  ...
  return (
    <div className={`bg-white p-4 md:p-6 rounded-xl border ${alert ? 'border-red-200 shadow-[0_0_15px_rgba(239,68,68,0.1)]' : 'border-navy/5 shadow-sm'}`}>
...
const OrdersProfits = () => {
  ...
  return (
    <div className="space-y-6 md:space-y-8 pb-8 md:pb-12 relative">
      ...
      {rejectingOrderId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-navy/40 backdrop-blur-sm">
          <motion.div 
            ...
            className="bg-white p-4 md:p-6 rounded-xl shadow-2xl w-full max-w-md"
          >
